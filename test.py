...
class NewsletterAgents:
    def __init__(self, model_name: str = "gpt-4o", api_key: str = None, exa_api_key: str = None):
        """
    ...
    def run_pipeline(self, user_input: str) -> Dict[str, Any]:
        ...
        insights_input = BaseInputSchema(
            chat_message=(
        ...
        insights_result = self.insights_expert.run(insights_input)
        ...
        writing_input = BaseInputSchema(
            chat_message=f"Transform these insights about {user_input} into engaging newsletter content:\n\n{insights_content}"
        )
        writing_result = self.writer.run(writing_input)
        newsletter_draft = writing_result.response_message
        print("✅ Draft created")
        
        # Stage 4: Editing
        print("\n📝 Stage 4: Editing and finalizing...")
        editing_input = BaseInputSchema(
            chat_message=(
        ...
        editing_result = self.editor.run(editing_input)
...
if __name__ == "__main__":
    ...
    agents = NewsletterAgents(model_name="gpt-4o", exa_api_key=exa_api_key)
